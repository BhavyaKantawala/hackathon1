            ...
            <div class="container-fluid h-100">
                <div class="row h-100 align-items-center justify-content-center text-center">
                    <div class="col-lg-8 align-self-end mb-4 page-title">
                    	<h3 class="text-white">Welcome to Alumni Management System of THE0078E</h3>
                        <hr class="divider my-4">
                        <h5 class="text-white">Hello Fellow Allumni's and Aspiring Students who want to study with us!<br>You can connect with the 0078E Community from this Gateway.</h5>
